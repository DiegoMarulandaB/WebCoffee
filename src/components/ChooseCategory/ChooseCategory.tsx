          ...
          result.map((category: CategoryType) => (
            ...
            >
              <img
                ...
                rel="preconnect"
                className="max-w-[272px] relative flex items-center justify-center px-6 py-2 aspect-auto object-cover transition-transform duration-150 ease-in-out hover:scale-125  rounded-lg"
              />
